...
for dim in $(seq $MINDIM $STEP $MAXDIM); do
    ...
    # redirect_cmd python -u random_restart_ica.py -f $FILE -i $ITER -o $outsubdir -t $TOL -d $dim 2>&1
    # redirect_cmd python -u compute_distance.py -i $ITER -o $outsubdir 2>&1
    # redirect_cmd python -u cluster_components.py -i $ITER -o $outsubdir 2>&1
